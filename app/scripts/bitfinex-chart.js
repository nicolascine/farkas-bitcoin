  class BitfinexChart {
      ...
      setChartSeries(data) {
          ...
          if (!this.isReady) {
              this.countItems++
              if (this.countItems == 3) this.isReady = true
          } else {
            $('.collecting-data-loader').fadeOut('slow')
          }
      ...
      setLoading() {
          $('.collecting-data-loader').css('width', $('.highcharts-container').width())
          $('.collecting-data-loader').css('height', $('.highcharts-container').height())
      }
  }
